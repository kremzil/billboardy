# Dočasné obrazové podklady — MHD Košice

Tieto grafiky sú dočasné podklady pre stránku reklamy v MHD Košice.

## Hero električky

- Zdroj: [Vario LF2+ Košice č801](https://commons.wikimedia.org/wiki/File:Vario_LF2%2B_Ko%C5%A1ice_%C4%8D801.JPG)
- Autor: Adehertogh
- Licencia: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
- Lokálny súbor `hero-tram-kosice.webp` je upravená verzia: orez a konverzia do formátu WebP.

## Schémy reklamných plôch DPMK
