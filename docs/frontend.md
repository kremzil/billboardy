...
Локальная навигация `Autobusy / Električky / Verejné osvetlenie` оформлена отдельной липкой полосой цвета `bb-control`; светлые контрастные чипы не теряются между красным информационным блоком и белым контентом страницы.
