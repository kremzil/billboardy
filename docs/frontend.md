...
В блоке `Verejné osvetlenie` находится нативный интерактивный аккордеон с официальной категоризацией улиц DPMK для smerové tabule: категории A, B и C раскрывают соответствующие списки улиц и типов размещения без дополнительного JavaScript.
